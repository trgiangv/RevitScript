...
using NLog;
using RevitScript.Runtime.Common.Extensions;
...
namespace RevitScript.Runtime.Engine {
    ...
    public class IronPythonEngine : ScriptEngine {
        ...
        private Microsoft.Scripting.Hosting.ScriptEngine Engine { get; set; }
        private IronPythonEngineConfigs ExecEngineConfigs = new();

        private static Tuple<Stream, System.Text.Encoding> DefaultOutputStreamConfig {
            get =>
                (Tuple<Stream, System.Text.Encoding>)AppDomain.CurrentDomain.GetData(DomainStorageKeys
                    .IronPythonEngineDefaultOutputStreamCfgKey);

            set => AppDomain.CurrentDomain.SetData(DomainStorageKeys.IronPythonEngineDefaultOutputStreamCfgKey, value);
        }

        private static Tuple<Stream, System.Text.Encoding> DefaultInputStreamConfig {
        ...
        public override int Execute(ref ScriptRuntime runtime) {
            // Set up the command scope in this engine with proper builtin and scope parameters
        ...
        private void SetupStdlib(Microsoft.Scripting.Hosting.ScriptEngine engine) {
            ...
            RevitScript.Runtime.Core.ScriptExecutor tempExec = new RevitScript.Runtime.Core.ScriptExecutor();
