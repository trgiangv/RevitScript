...
using Shared_ExecParams = RevitScript.Runtime.Shared.ExecParams;
...
namespace RevitScript.Runtime.Engine
{
    ...
    {
        public Shared_ExecParams CurrentExecParams { get; set; }
    ...
    public class CLREngine : ScriptEngine
    {
        ...
        public static int ExecuteExternalCommandType(Type extCommandType, ref ScriptRuntime runtime)
        {
            ...
            // set ExecParams
            var execParams = new Shared_ExecParams(
            ...
            {
                if (fieldInfo.FieldType == typeof(Shared_ExecParams))
                {
